...
class SetModelFactory extends SingleModelFactory
{
    protected function createModelHeader(): void
    {
		...
		$singleClassNamespace =  $this->namespaceSingle . '\\'. $this->className;
        $this->fileLines[] = '<?php';
        $this->fileLines[] = '';
        ...
        $this->fileLines[] = 'use ' . $singleClassNamespace . ' as ' . $this->className . ';';
        $this->fileLines[] = '';
        ...
        $this->fileLines[] = '{';
        $this->fileLines[] = [1];
        $this->fileLines[] = 'protected static ?string $workerClass = "' . $singleClassNamespace . '";';
